    ...
    <div className="flex items-center justify-between relative p-5">
      ...
      <div className="flex items-center space-x-3">
        ...
        <button
          ...
          className="flex items-center space-x-2 dark:border-dark-subtle border-light-subtle hover:border-primary dark:text-dark-subtle text-light-subtle hover:opacity-80 transition font-semibold border-2 rounded text-lg px-3 py-1"
        >
          <span>Create</span>
          <AiOutlinePlus />
        </button>
